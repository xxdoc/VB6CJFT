...
Private Sub Command1_Click()
    ...
    strSQL = "SELECT DeptID ,DeptName ,ParentID FROM tb_FT_Sys_Department WHERE 1<>1 "
    ...
    If rsAdd.State = adStateOpen Then
        ...
        Call gsLogAdd(Me, udInsert, "tb_FT_Sys_Department", "添加新部门【" & lngDeptID & "】【" & strDeptName & "】")
...
Private Sub Command2_Click()
    ...
    If rsEdit.State = adStateOpen Then
        If rsEdit.RecordCount = 1 Then
            ...
            rsEdit.Close
            Call msLoadDept(TreeView1)
            Call gsLogAdd(Me, udUpdate, "tb_FT_Sys_Department", strMsg)
...
Private Sub Form_Load()
    ...
    Me.Icon = gWind.ImageList1.ListImages("SysDepartment").Picture
    Text1.Item(0).Text = ""
    Text1.Item(1).Text = ""
...
Private Sub Form_Resize()
    ...
    If Me.WindowState <> vbMinimized Then
        If Me.Height > conHeight Then
            ...
            End If
        End If
        TreeView1.Height = IIf(blnAlter, Me.ScaleHeight, conHeight) - conEdge * 2
    End If
