...
CREATE DATABASE [db_FT]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'db_FT', FILENAME = N'D:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\db_FT.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'db_FT_log', FILENAME = N'D:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\db_FT_log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [db_FT] SET COMPATIBILITY_LEVEL = 110
GO
...
ALTER DATABASE [db_FT] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [db_FT] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
